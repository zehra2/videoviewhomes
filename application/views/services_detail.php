...
<section class="aboutus" style="margin-bottom: 0px !important;">
    <div class="container">
        <h2 style="margin-bottom: 10px;margin-top: 20px !important;">Service Detail</h2>
    ...
    <div class="containexr">
        <div class="row">
            ...
            <div class="row mt-50" style=" border-bottom: 1px solid #ddd;">
                ...
                <div class="col-12 col-md-12 prd-title-btn-info center" style="display: flex;justify-content: space-between;column-gap: 10px;margin-bottom: 10px;">
                    <h4 style="cursor:pointer;content-align:center; text-transform: uppercase;"><?php echo $row->service;?></h4>
                ...
                <div class="col-12 col-md-12 prd-price" style="display: flex;column-gap: 10px;margin-bottom: 10px;">   
                    <h4  class="color-h4"style="font-size: 18px;font-weight: 600;">Year of Experience:&#160;&#160;&#160; <?php echo $row->exp;?> </h4>
                </div>
        ...
        <div class="col-md-3">
            <div class="contactBox" style="margin-top: 12px;">
                <div class="headingBox">Services</div>
                <div class="content">
                    <ul>
                    <?php if($product){
                       ...
                       <li <?php if($data->id == $row->id){?> style="background: #eee;"<?php }?>>
                            ...
                            <span onclick="products_detail('<?php echo $data->id;?>')"><?php echo $data->service;?></span>                       
                        </li>
                    <?php }}?>
                    </ul>
                </div>
