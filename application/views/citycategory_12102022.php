    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h2> <?php echo str_replace('%20', ' ', $city);?> <i class="fa fa-angle-right"></i> Categories</h2>
            </div>
            <?php /*<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <select name="category_id" id="category_id" onchange="window.location.href=this.value;" style="width:50%;height: 35px;">
                    <option>Select</option>
                    <?php if($data){
						foreach($data as $item){?>
                        <option value="<?php echo base_url();?>categoryvendor/<?php echo $item->category_id;?>/<?php echo $city_id;?>"><?php echo $item->name;?></option>
					<?php }}?>
                </select>
            </div>*/?>
