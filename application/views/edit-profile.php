...
<section class="service-form">
    <div class="container">
        <div class="row">
            ...
            <form class="serviceForm submitRegForm" method="post" action='<?php echo base_url('saveEditProfile'); ?>' enctype="multipart/form-data">
			...
			<?php if(!empty($this->session->flashdata('errors'))){ ?>
                ...
                <div class="row" style="margin-top: 10px;">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					    <?php if($image){?>
					        <img src="public/user-image/<?php echo $image;?>" style="width: 75px;">
					    <?php }?>
                        <label>Image:</label>
                        <br>
                        <!--<input type="file" name="image" id="image"  accept="image/*" value="<?php echo $image;?>>
						-->
						<input type="file" id="ConsumerPic" value="Photo" name="ConsumerPic" onchange="getfilename(this);" accept=".jpg, .jpeg, .png, .gif, .tiff, .psd, .pdf, .eps, .ai, .indd, .raw, .svg, .webp"/>

                      
					
						<INPUT TYPE="hidden" ID="add" NAME="result" VALUE=""/>
...
<script type="text/javascript">
    function getfilename(input) {
		...
		document.getElementById('add').value = fileName;
...
$('.submitReg').click(function(){
           ...
           $.ajax({
            url: "<?php echo base_url('formValidationEditProfile');?>",
            type: "POST",
