...
<section class="service-form">
    <div class="container">
        <div class="row">
            ...
            <h2 style="margin: 0px !important;margin-top: 15px !important;">Subscription Form</h2>
          </div>
			...
			<?php if(!empty($this->session->flashdata('errors'))){ ?>
				...
				<div class="row" >
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <label>Years:<span class="field_required">*</span></label>
                        <br>
                        <input type="number" name="years" id="years" value="1" required>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
