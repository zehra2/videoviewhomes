...
<head>
    ...
    <link rel="shortcut icon" type="image/png"
        href="https://videoviewhomesandrentals.com/assets/uploads/logo/logo162043290174163466960570.png">
    <meta name="keywords"
        content="Video View Live Streaming Goods and services streamed Internationally">
    <meta name="description"
        content="Video View Live Streaming Goods and services streamed Internationally">
    ...
    <!-- FOR NEW STREMING -->
    <script src="<?php echo base_url().'assets/';?>js/external/adapter-latest.js"></script>
...
<body class="responsive" data-gr-c-s-loaded="true">
    ...
    .header-navigation-menu .navbar-nav>li { margin-top: 25px;}
            ...
            <div class="container" style="padding:0; max-width:100%">
                <div class="row align-items-center">
                    <div class="col-md-2 col-sm-2 col-6 no-margin">
                        <div class="logoimg">
                            <a href="<?php echo base_url();?>" class="navbar-brand" style="width:100%">
                        ...
                        <nav class="navbar navbar-default justify-content-center">
                            <div id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="mob-hide" style="margin-top: 0px;">
                                        <img src="<?php echo base_url();?>assets/images/logo2.jpeg" style="width: 80px;">
                                    </li>
                                    <!-- <li>
                                        <div class="sumitlist">
