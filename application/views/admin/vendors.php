      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Vendors
    ...
    -webkit-box-orient: vertical;
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="box">
                     <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Vendors</h3>
                        <div class="box-tool">
										...
										<table class="table table-striped table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo ($data->user_type == 1)?'Product Provider':'Service Provider';?></td>
													...
													<td><a href="<?php echo base_url('admin/home/vendors_delete/'.$data->id);?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
												</tr>
												<?php 
											}}?>
											</tbody>
