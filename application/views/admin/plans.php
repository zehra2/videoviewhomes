      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Plans
                  <a href="<?php echo base_url('admin/home/plans_detail');?>" class="btn btn-primary" style="float:right">Add New</a>
                  </h1>
										...
										<table class="table table-striped table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo ($data->type == 1)?'Yearly':'Monthly';?></td>
