      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Permissions Detail</h1>
               </div>
            </div>
            <!-- END Page Title -->
<?php 
               ...
               <div class="col-md-12">
                  <div class="box">
                     ...
                     <div class="box-content">
                        <form action="<?php echo base_url('admin/home/savePermissions');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
