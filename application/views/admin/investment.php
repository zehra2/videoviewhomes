      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Investment Projects
                  <a href="<?php echo base_url('admin/home/investment_detail');?>" class="btn btn-primary" style="float:right">Add New</a>
                  </h1>
    ...
    -webkit-box-orient: vertical;
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="box">
                     <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Investment Projects</h3>
                        <div class="box-tool">
                           ...
                           <a data-action="close" href="#"><i class="fa fa-times"></i></a>
                                ...
                                <div class="table-responsive">
											...
											<tbody>
												...
												<tr>
													...
													<td>
												        ...
												        <iframe width="150px" height="100px" src="<?php echo $data->youtube_link;?>"
                                        ...
                                        allowfullscreen></iframe>
													...
													<td><a href="<?php echo base_url('admin/home/investment_detail/'.$data->id);?>" class="btn btn-info">Edit</a>
													| <a href="<?php echo base_url('admin/home/investment_delete/'.$data->id);?>" class="btn btn-danger">Delete</a></td>
