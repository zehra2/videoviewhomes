      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Sub Category Detail</h1>
               </div>
            </div>
            <!-- END Page Title -->
<?php 
               ...
               <div class="col-md-12">
                  <div class="box">
                     ...
                     <div class="box-content">
                        <form action="<?php echo base_url('admin/home/saveSubCategory');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Category: </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <select class="form-control " name="parent_id" required>
                                     <option vaule="">Select Category</option>
                                     <?php if($category){
                                         foreach($category as $data){?>
                                         <option value="<?php echo $data->id;?>" <?php echo ($data->id == $parent_id)?'selected':'';?>><?php echo $data->name;?></option>
