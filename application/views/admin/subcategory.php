      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Sub Category
                  <a href="<?php echo base_url('admin/home/subcategory_detail');?>" class="btn btn-primary" style="float:right">Add New</a>
                  </h1>
										...
										<table class="table table-striped table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href="<?php echo base_url('admin/home/subcategory_detail/'.$data->id);?>" class="btn btn-info">Edit</a>
													| <a href="<?php echo base_url('admin/home/subcategory_delete/'.$data->id);?>" class="btn btn-danger">Delete</a></td>
