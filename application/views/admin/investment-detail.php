      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Investment Detail</h1>
               </div>
            </div>
            <!-- END Page Title -->
<?php 
               ...
               <div class="col-md-12">
                  <div class="box">
                     ...
                     <div class="box-content">
                        <form action="<?php echo base_url('admin/home/saveInvestment');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input class="form-control " name="youtube_link" required="" value="<?php echo $youtube_link;?>">
                              </div>
                           </div>
