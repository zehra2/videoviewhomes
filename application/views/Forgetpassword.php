...
<section class="service-form">
    <div class="container">
        <div class="row">
            ...
            <form class="serviceForm" method="post" action='<?php echo base_url('signindbemail'); ?>'>
			<?php if(!empty($this->session->flashdata('errors'))){ ?>
                ...
                <div class="row" style="margin-top: 25px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <label>Re-Enter Email<span class="field_required">*</span></label>
                        <br>
                        <input type="text" name="re-email" required>
                    </div>
                </div>
