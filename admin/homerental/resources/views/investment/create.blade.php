    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Add Investment</li>
            </ol>
        </nav>
        ...
        <div class="card col-md-8 m-auto">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('create-investment') }}">
                  @csrf
                    <div class="form-group">
                      <label for="name">Name</label>
                      <input type="text" name="name" id="name" placeholder="Investment Name"
                      class="form-control @error('name') border border-danger @enderror" value="{{ old('name') }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control @error('name') border border-danger @enderror">{{ old('youtube_link') }}</textarea>
                    </div>
