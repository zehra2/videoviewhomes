...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/assets2/css/fbstyle.css" />
...
<body class="responsive" data-gr-c-s-loaded="true">
    ...
    font-weight: 400;
        ...
        .submit-property {
            background: linear-gradient(45deg, #05595B, #062C30), url(assets/images/register.jpg) !important;
    ...
    <section class="submit-property h-100 w-100">
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-6 col-sm-12 col-xs-12">
                                    <div class="passworduser">
                                        ...
                                        <select class="form-control country_2 countries" id="countryId" name="country"
                                            required>
                                            <option value="{{ old('country') ? old('country') : '' }}">
                                                {{ old('country') ? old('country') : 'Select Country' }}</option>
                                ...
                                <div class=" col-md-6 col-sm-12 col-xs-12">
                                    <div class="passworduser">
                                        ...
                                        <select class="state form-control  state states" name='state'
                                            id="stateId" required>
                                            <option value="{{ old('state') ? old('state') : '' }}">
                                                {{ old('state') ? old('state') : 'Select State' }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class=" col-md-6 col-sm-12 col-xs-12">
                                    <div class="passworduser">
                                        ...
                                        <select class="city form-control cities" name='city' id="cityId"
                                            required>
                                            <option value="{{ old('city') ? old('city') : '' }}">
                                                {{ old('city') ? old('city') : 'Select City' }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class=" col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class=" col-md-12 col-sm-6 col-xs-6 text-center">
                                    <button type="submit" class=" fileloginbtn">Signup </button>
                                </div>
                                <div class=" col-md-12 col-sm-6 col-xs-6 text-center">
                                    <p class="m-0 text-white">Already Have account? <a href="{{ url('/login') }}"
                                            style="color:#49cdd1;">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function() {
            ...
            var selectedCountry = $(".country_2 option:selected").val();
            $.ajax({
                type: "POST",
                url: base_url + "login/country_to_state",
                data: {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "login/state_to_city",
                data: {
                    state: selectedState
                }
            }).done(function(data) {
        ...
        $("select.country_2").on('change', function() {
            var selectedCountry = $(".country_2 option:selected").val();
 ...
 <script>
        ...
        $('#customSignupForm').submit(function() {

            var data = new FormData(document.getElementById("customSignupForm"));
            // Get post url
    ...
    <script>
        ...
        function locationInfo() {
            ...
            this.confCity = function(id) {
                var url = rootUrl + '?type=confCity&countryId=' + jQuery('#countryId option:selected').attr(
                    'countryid') + '&stateId=' + jQuery('#stateId option:selected').attr('stateid') + '&cityId=' + id;
                var method = "post";
                var data = {};
            ...
            this.getCities = function(id) {
                ...
                var url = rootUrl + '?type=getCities&countryId=' + jQuery('#countryId option:selected').attr(
                    'countryid') + '&stateId=' + id + addParams + addClasses;
                var method = "post";
                var data = {};
